...
set _SOURCEPATH=src\java
set _CLASSES=build\web\WEB-INF\classes
...
"%_JAVACCMD%" -encoding UTF-8 -d %_CLASSES% -classpath %_CLASSPATH% %_SOURCEPATH%\entityclasses\*.java %_SOURCEPATH%\ormsamples\*.java 
